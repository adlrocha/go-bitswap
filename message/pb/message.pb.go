...
type Message_CompressionType int32

const (
	Message_None             Message_CompressionType = 0
	Message_Gzip             Message_CompressionType = 1
	Message_BlockCompression Message_CompressionType = 2
)

var Message_CompressionType_name = map[int32]string{
	0: "None",
	1: "Gzip",
	2: "BlockCompression",
}

var Message_CompressionType_value = map[string]int32{
	"None":             0,
	"Gzip":             1,
	"BlockCompression": 2,
}

func (x Message_CompressionType) String() string {
	return proto.EnumName(Message_CompressionType_name, int32(x))
}

func (Message_CompressionType) EnumDescriptor() ([]byte, []int) {
...
type Message struct {
	...
	Compression       Message_CompressionType `protobuf:"varint,6,opt,name=compression,proto3,enum=bitswap.message.pb.Message_CompressionType" json:"compression,omitempty"`
	CompressedPayload []byte                  `protobuf:"bytes,7,opt,name=compressedPayload,proto3" json:"compressedPayload,omitempty"`
}
...
func (m *Message) GetCompression() Message_CompressionType {
	if m != nil {
...
func (m *Message) GetCompressedPayload() []byte {
	if m != nil {
		return m.CompressedPayload
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("bitswap.message.pb.Message_CompressionType", Message_CompressionType_name, Message_CompressionType_value)
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CompressedPayload) > 0 {
		i -= len(m.CompressedPayload)
		copy(dAtA[i:], m.CompressedPayload)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.CompressedPayload)))
		i--
		dAtA[i] = 0x3a
	}
	if m.Compression != 0 {
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Compression |= Message_CompressionType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompressedPayload", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CompressedPayload = append(m.CompressedPayload[:0], dAtA[iNdEx:postIndex]...)
			if m.CompressedPayload == nil {
				m.CompressedPayload = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
